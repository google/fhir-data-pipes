...
class Observation:
    ...
    def openmrs_convert(self, new_patient_id: str, encounter_list: List[Encounter]):
        """Change fields to make Encounter uploadable to OpenMRS.
        ...
        for encounter in encounter_list:
            if encounter.base.original_id == base_id:
                self.base.json["encounter"]["reference"] = (
                    "Encounter/" + encounter.base.new_id
                )
                break
        ...
        if (
            self.base.json["code"]["coding"][0]["code"]
