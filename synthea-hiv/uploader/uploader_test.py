...
class UploaderTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self._upload_resource = mock.patch.object(
            uploader.Uploader, "_upload_resource", return_value="123"
        ).start()
    ...
    def test_upload_bundle_openmrs(self):
        ...
        upload_handler.upload_openmrs_bundle(
            pathlib.PosixPath(temp_file.name), mock_location
        )
            ...
            "entry": [
                {
                    "resource": {
                        ...
                        "text": {
                            "status": "generated",
                            "div": '<div xmlns="http://www.w3.org/1999/xhtml"><h2>Unknown '
                            "Location</h2><h2/></div>",
                        },
                        "status": "active",
            ...
            "entry": [
                {
                    ...
                    "resource": {
                        ...
                        "telecom": [
                            {"system": "phone", "value": "555-338-1943", "use": "home"}
                        ],
                        "gender": "male",
