...
class ResourcesTest(unittest.TestCase):
    ...
    def test_openmrs_convert_patient(self):
        ...
        self.assertEqual(
            test_patient.base.original_id, "2a76c0e3-1e73-2109-3d5e-8a8871fe35d7"
        )
        self.assertEqual(test_patient.base.json["identifier"], [])
        test_patient.openmrs_convert()
        self.assertEqual(
            test_patient.base.json["identifier"],
            [
                {
                    "extension": [
                        {
    ...
    def test_openmrs_convert_encounter(self):
        ...
        self.assertEqual(
            test_encounter.base.original_id, "e1846945-43bb-3cfe-1faf-66cf99935c7c"
        )
        location = ("456", "World")
        test_encounter.openmrs_convert("123", location)
        self.assertEqual(
            test_encounter.base.json["type"],
            [
                {
                    "coding": [
                        {
        ...
        self.assertEqual(
            test_encounter.base.json["location"],
            [{"location": {"reference": "Location/456", "display": "World"}}],
        )
        self.assertEqual(
            test_encounter.base.json["subject"]["reference"], "Patient/123"
        )
    ...
    def test_openmrs_convert_observation(self):
        ...
        self.assertEqual(
            test_observation.base.original_id, "e0f03934-1b25-6f93-e437-b554af10675e"
        )
        ...
        self.assertEqual(
            test_observation.base.json["subject"]["reference"], "Patient/123"
        )
        self.assertEqual(
            test_observation.base.json["encounter"]["reference"], "Encounter/5678"
        )
