...
public class ReadJsonFilesTest {
	...
	@Mock
	private FileIO.ReadableFile fileMock;
	...
	public void setUp() throws PropertyVetoException, SQLException {
		...
		readJsonFilesFn = new ReadJsonFilesFn(options) {
	...
	public void testProcessBundleUrnRef() throws IOException, java.text.ParseException, SQLException {
		String bundleResourceStr = Resources.toString(Resources.getResource("bundle_urn_ref.json"), StandardCharsets.UTF_8);
		...
		assertThat(obs.getSubject().getReference(), equalTo("Patient/437a1b3e-1b17-ae3c-24f8-6079abe1ddc4"));
		// The referenced Encounter is not present in the Bundle.
		assertThat(obs.getEncounter().getReference(), equalTo("urn:uuid:2b442f5f-4f54-75ae-977b-1388db732966"));
	}
	
	@Test
	public void testProcessBundleRelativeRef() throws IOException, java.text.ParseException, SQLException {
		String bundleResourceStr = Resources.toString(Resources.getResource("bundle_relative_ref.json"),
