...
public class JdbcResourceWriterTest {
	...
	public void setup() throws IOException, SQLException {
		patientResourceStr = Resources.toString(Resources.getResource("patient.json"), StandardCharsets.UTF_8);
	...
	public void testWriteResource() throws SQLException {
		JdbcResourceWriter testWriter = new JdbcResourceWriter(dataSourceMock, TABLE_PREFIX, false, fhirContext);
	...
	public void testWriteResourceSingleTable() throws SQLException {
		JdbcResourceWriter testWriter = new JdbcResourceWriter(dataSourceMock, TABLE_PREFIX, true, fhirContext);
		testWriter.writeResource((Resource) parser.parseResource(patientResourceStr));
