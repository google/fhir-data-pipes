...
public interface ParquetMergerOptions extends BasePipelineOptions {
  ...
  @Description(
      "The directory from which SQL-on-FHIR-v2 ViewDefinition json files are read. Note: This"
          + " directory must contain all the ViewDefinitions used to create views in both"
          + " data-warehouses!")
  @Default.String("")
  ...
  @Description("If set, flat Parquet files corresponding to input ViewDefinitions are merged.")
  @Default.Boolean(false)
  Boolean isMergeParquetViews();

  void setMergeParquetViews(Boolean value);
