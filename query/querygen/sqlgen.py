...
import os
import stanza
from .terminology_indexer import TerminologyIndexer, CLOSE_CONCEPT_DISTANCE_THRESHOLD, MAX_CLOSE_CONCEPTS
from .db_description import DbDescription
from .column_sampler import ColumnSampler
from . import PRINT_FINAL_PROMPT, PRINT_CLOSE_CONCEPTS, PRINT_MODEL_RESPONSE
...
class SqlGen:
    ...
    def __init__(self, target_db_url: str, pg_vector_db_url: str, nlp_ner: stanza.Pipeline = None,
        ...
        self._column_sampler = ColumnSampler(self._target_db, num_samples=num_column_samples)
...
"""
    ...
    def iterative_gen_sql(self, query: str, table_suffix: str = '', num_rounds: int = 3):
