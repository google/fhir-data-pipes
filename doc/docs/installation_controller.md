...
Once deployed, the transformation pipeline can be managed via the Command Line
...
!!! info "Info"
    ...
    The bottom area of the control panel shows the options being used by the Pipelines Controller.
