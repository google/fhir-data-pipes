...
_PatientQueryClass = partial(ql_spark.patient_query_factory, ql_spark.Runner.SPARK, _SPARK_BASE_DIR, _CODE_SYSTEM)
#_PatientQueryClass = partial(ql_spark.patient_query_factory, ql_spark.Runner.BIG_QUERY, _BIGQUERY_DATASET, _CODE_SYSTEM)
...
class BigQueryPatientQueryTest(unittest.TestCase):
  ...
  def test_obs_basic_query_include_all_other_codes(self):
    ...
    patient_query = _PatientQueryClass()
