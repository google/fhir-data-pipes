...
public class FhirUriGeneratorTest extends CamelTestSupport {
        ...
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from(EVENTS_HANDLER_ROUTE)
                        .process(new FhirUriGenerator()) // inject target processor here
                        .to("mock:result");
            }
        };
    }
    ...
    public void shouldEnsureAllOpenMrsCoreTablesHaveBeenFhirMapped() throws Exception {
        ...
        String tables[] = { "obs", "encounter", "location", "cohort",
                "person", "provider", "relationship", "patient",
                "drug", "allergy", "order", "drug_order",
                 "test_order", "visit", "program", "patient_program"};
